...
{{/*
Create the name of the kafka configmap
*/}}
...
{{/*
Return true if a configmap object should be created for controller
*/}}
{{- define "kafka.controller.createConfigmap" -}}
{{- if and .Values.controller.config (not .Values.controller.existingConfigmap) }}
    {{- true -}}
{{- end -}}
{{- end -}}
